...
\subsection{Diverses}
    ...
    \textbf{Konstanten}\\
    \begin{tabular}{ll}
    	$c=299'792'458 \frac{m}{s}$&TR: cLicht\\
    	$h=6.626'070'040 \cdot 10^{-34}Js$&TR: hPlank\\
    	$1ev = 1.602'176'621\cdot 10^{-19}J$&TR: ev
    \end{tabular}
  \end{minipage}
  \begin{minipage}[t]{0.24\textwidth}
  	\textbf{Wellenlänge vs. Frequenz}\\
  	$c=\lambda \cdot f$\\
  	\textbf{Energie eines Photons}\\
  	$E = h \cdot f$\\
  \end{minipage}
  \begin{minipage}[t]{0.24\textwidth}
...
\subsection{Geometrische Optik \kuchling{360}}
...
\subsection{Spiegel \kuchling{362}}
\begin{minipage}[]{4cm}
...
\subsection{Linsen \kuchling{369} }
\begin{minipage}[]{3.5cm}
  Sammel-Konvexlinsen\\
  $f>0,g>0$\\  
  $q=\frac{d}{f}$
\end{minipage}
\begin{minipage}[]{3cm}
  \includegraphics[width=3cm]{./bilder/sammelprinzip_2.png}
\end{minipage}
\begin{minipage}[]{5cm}
...
\subsubsection{Lupe \kuchling{381}}
\begin{tabular}{lll}
...
\subsubsection{Kamera \kuchling{378}}
\begin{tabular}{lll}
  \parbox{3cm}{
...
\subsubsection{Mikroskop \kuchling{382}}
\begin{tabular}{ll}
  \parbox{8cm}{
...
\subsubsection{Keplersches (Astronomisches) Fernrohr \kuchling{383}}
\begin{tabular}{ll}
  \parbox{10cm}{
...
\subsubsection{Diverse \kuchling{384}}
\begin{tabular}{ll}
  Terrestr. Fernr. & 
